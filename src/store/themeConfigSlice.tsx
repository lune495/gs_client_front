...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        setPageTitle(state, { payload }) {
            document.title = `${payload} | GOLDEN TECH`;
        },

        setEleveId(state, { payload }) {
            localStorage.setItem('eleveId', JSON.stringify(payload));
        },
        setApeScolUser(state, { payload }) {
            localStorage.setItem('chiffaa_user', JSON.stringify(payload));
        },
        setDisconnect(state, { payload }) {
            localStorage.removeItem('chiffaa_user');
        },
        setAnneeScolaire(state, { payload }) {
            localStorage.setItem('annee_scolaire',JSON.stringify(payload));
        },
    },
});

export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setPageTitle, setEleveId,setApeScolUser,setDisconnect,setAnneeScolaire } = themeConfigSlice.actions;
