...
const Remboursement = () => {
            ...
            await sendData(
                ...
                .then(async (resp:any)=> {
                   ...
                   if(resp?.data?.data){
                        ...
                        showMessage(`Remboursement ${msg} avec succès.`);
   ...
   const handleFilter=(e:any)=>{
    ...
    const getStatus=async()=>{
        ...
        setFilteredItems(data?.data?.transactions?.filter((e:any)=>e.credit>0));
    }
    ...
    return (
        <div>
                        ...
                        <table className="table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Montant du remboursement (Fcfa)</th>
                                    {/* <th>Solde (Fcfa)</th> */}
                                    ...
                                    return (
                                        <tr style={{backgroundColor:"#e0dfdc"}} key={contact.id}>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                                <div className="flex items-center w-max">
                                                    <div>{contact?.credit?.toLocaleString()}</div>
                                                </div>
                                            </td>
                                              {/* <td>
                                                <div className="flex items-center w-max">
            ...
            {addContactModal && <TransactionForm  loading={loading}  data={{}} open={addContactModal} setOpen={()=>{setResponse({});setAddContactModal(false)}} handleValidate={(e:any)=>saveUser(e)}/>}
          </div>
        </div>
    );
};
